...
async function handleBayar() {
  ...
  try {
    ...
    console.error("Gagal menyimpan data atau membuka Tonkeeper:", error);
    document.getElementById("status").textContent = "Terjadi kesalahan saat memproses pembayaran.";
  }
}
...
window.onload = () => {
  ...
  if (bayarBtn) bayarBtn.addEventListener("click", handleBayar);
};
